...
scp -p $CURRENT_BACKUP_CANDIDATES.gz $REMOTE_LOCATION/$CURRENT_BACKUP_CANDIDATES.$DAY.gz
scp -p $CURRENT_BACKUP_NONCANDIDATES.gz $REMOTE_LOCATION/$CURRENT_BACKUP_NONCANDIDATES.$DAY.gz
